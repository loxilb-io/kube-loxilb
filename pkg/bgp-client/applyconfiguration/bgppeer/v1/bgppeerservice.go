...
import (
	crdsbgppeerv1 "github.com/loxilb-io/kube-loxilb/pkg/crds/bgppeer/v1"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	types "k8s.io/apimachinery/pkg/types"
	v1 "k8s.io/client-go/applyconfigurations/meta/v1"
)

// BGPPeerServiceApplyConfiguration represents an declarative configuration of the BGPPeerService type for use
// with apply.
type BGPPeerServiceApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *BGPPeerModelApplyConfiguration     `json:"spec,omitempty"`
	Status                           *crdsbgppeerv1.BGPPeerServiceStatus `json:"status,omitempty"`
}

// BGPPeerService constructs an declarative configuration of the BGPPeerService type for use with
// apply.
func BGPPeerService(name string) *BGPPeerServiceApplyConfiguration {
	b := &BGPPeerServiceApplyConfiguration{}
	b.WithName(name)
	b.WithKind("BGPPeerService")
	b.WithAPIVersion("bgppeer.loxilb.io/v1")
	return b
}
...
func (b *BGPPeerServiceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
